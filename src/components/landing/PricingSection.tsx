        ...
        <div className="max-w-md mx-auto">
          <Card className="p-8 border-2 border-primary bg-gradient-to-b from-primary/5 to-accent/5">
            <div className="text-center">
              ...
              <div className="text-gray-400 mb-6">/mês</div>
              ...
              <ul className="text-left space-y-3 mb-8">
                <li className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-white">Dashboard completo</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-primary" />
                  <span className="text-sm text-white">Controle ilimitado</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-primary" />
                  <span className="text-sm text-white">Relatórios avançados</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-primary" />
